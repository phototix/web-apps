...
function app_dispatch_request(): void
{
    ...
    $routes = [
        'GET' => [
            ...
            '/expired' => 'app_page_expired',
            '/restricted' => 'app_page_restricted',
            '/logout' => 'app_page_logout',
            '/sso-connect' => 'app_page_webbycloud_connect',
            '/auth/webbycloud/callback' => 'app_page_webbycloud_callback',
            ...
            '/settings/webbycloud-files' => 'app_page_webbycloud_files',
            '/files' => 'app_page_files',
            '/audits' => 'app_page_audits',
...
function app_dispatch_api_request(string $method, string $path): void
{
    ...
    $apiRoutes = [
        'GET' => [
            ...
            '/api/whatsapp/sessions/{id}/screenshot' => 'api_whatsapp_get_screenshot',
        ...
        'POST' => [
            ...
            '/api/pages/{id}/delete' => 'api_pages_delete',
            '/api/pages/{id}/generate' => 'api_pages_generate_existing',
            '/api/reports/pages' => 'api_reports_create_page_from_csv',
            '/api/reports/pages/generate' => 'api_reports_generate_page_from_csv',
            ...
            '/api/whatsapp/groups/{id}/schedule-summary/delete' => 'api_whatsapp_delete_group_schedule_summary',
            '/api/whatsapp/groups/{id}/schedule-summary/latest' => 'api_whatsapp_set_group_summary_latest',
